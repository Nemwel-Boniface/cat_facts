...
const Footer = () => (
  <footer className="bg-light text-center text-lg-start">
          ...
          <ul className="list-unstyled mb-0">
            <li>
              <span className="text-dark">
                ...
                by
                {' '}
                <a href="https://www.linkedin.com/in/nemwel-nyandoro/" className="text-dark" target="_blank" rel="noopener noreferrer">Nemwel</a>
              </span>
            </li>
            <li>
    ...
    <div className="text-center p-3" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
      ...
      {' '}
      Cat Fact Finder. All Rights Reserved.
    </div>
  </footer>
);
