            ...
            <header className="card-body d-flex align-items-center">
              ...
              <div>
                ...
                <p className="card-text">
                  Welcome back to Cat Fact Finder! Discover amazing facts about
                  cats and enhance your knowledge about our feline friends.
                </p>
                <button type="button" onClick={handleCatFactsFetch} className="btn btn-primary">
                  Fetch data…
                </button>
